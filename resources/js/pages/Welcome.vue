...
import { imagePaths } from '@/constants/images_path';
                ...
                >
                    ...
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        <li
                            ...
                            v-for="(link, index) in quickAccess.quickAccessItems"
                            :key="index"
                        >
                            ...
                            <span>
                                ...
                                <a
                                    :href="link.url"
                                    target="_blank"
                                    class="ml-1 inline-flex items-center space-x-1 font-medium text-[#003E7E] underline underline-offset-4 dark:text-[#7183B2] "
                                >
                                    <span class="hover:text-gray-900 dark:hover:text-[#DEE2ED]">{{ link.urlText
                                        }}</span>
                                    <svg
                                        width="10"
                                        height="11"
