            ...
            <div class="px-4 sm:px-6 lg:px-8">
                <div class="sm:flex sm:items-center">
                    <div class="sm:flex-auto">
                        <h1 class="text-base font-semibold text-gray-900">Perfis de Utilizadores</h1>
                        <p class="mt-2 text-sm text-gray-700">Uma lista de todos os os perfis criados na plataforma.</p>
                    </div>
